...
describe('Tutorial part 6', function () {
    ...
    describe('Heroes tests', function () {
        ...
        it('displays correctly styled buttons', function () { return __awaiter(_this, void 0, void 0, function () {
            var addButton;
            return __generator(this, function (_a) {
    ...
    describe('Progressive hero search', function () {
        beforeAll(function () { return protractor_1.browser.get(''); });
        it("searches for 'Ma'", function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
        ...
        it("continues search with 'g'", function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
